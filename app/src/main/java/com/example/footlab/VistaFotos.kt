...
class VistaFotos(
    ...
    private val onAnalizarClick: (String) -> Unit
    ...
    override fun onBindViewHolder(holder: VistaFoto, position: Int) {
        ...
        // Set up the click listener for the analyze button
    ...
    class VistaFoto(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val botonAnalizar: Button = view.findViewById(R.id.botonClasificarItem) // Ensure you have this button in your layout
    }
}
